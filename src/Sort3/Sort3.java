...
public class Sort3 {
    public static Comparable[] sort3 (Comparable[] list) {
    ...
    public static Comparable[] sort3(Comparable[] list1, Comparable[] list2, Comparable[] result) {
        System.arraycopy(sort3(mergeList(list1, list2)), 0, result, 0, result.length);
        return sort3(mergeList(list1, list2));
    }
